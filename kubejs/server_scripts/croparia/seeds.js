...
ServerEvents.recipes(event => {
      ...
      var cropariaSeeds = ["blaze", "silver", "dragon", "diamond", "emerald", "ender", "eye", "foot", "goat", "goldenapple", "lead2", "magma", "nautilus", "netherite", "phantom", "totem", "quartz", "redstone", "scute", "sea", "shard", "crystal", "shell", "star", "wither", "xp"];

...
if [ -f serverstarter-2.4.0.jar ]; then
    ...
    java $JAVA_FLAGS -jar serverstarter-2.4.0.jar
    ...
    export URL="https://github.com/Another-Quality-Series/ServerStarter/releases/download/v2.4.0/serverstarter-2.4.0.jar"
fi
echo $URL
which wget >> /dev/null
if [ $? -eq 0 ]; then
